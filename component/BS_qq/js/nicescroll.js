...
(function(e) {
    ...
    q = window.cancelRequestAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || false,
    x = false,
    E = function() {
        if (x) return x;
        ...
        for (var h = ["transform", "msTransform", "webkitTransform", "MozTransform", "OTransform"], i = 0; i < h.length; i++) if (typeof e.style[h[i]] != "undefined") {
            c.trstyle = h[i];
            break
        }
        c.hastransform = c.trstyle != false;
        if (c.hastransform) e.style[c.trstyle] = "translate3d(1px,2px,3px)",
        c.hastranslate3d = /translate3d/.test(e.style[c.trstyle]);
        c.transitionstyle = false;
        c.prefixstyle = "";
        c.transitionend = false;
        for (var h = "transition,webkitTransition,MozTransition,OTransition,OTransition,msTransition,KhtmlTransition".split(","), b = ",-webkit-,-moz-,-o-,-o,-ms-,-khtml-".split(","), n = "transitionend,webkitTransitionEnd,transitionend,otransitionend,oTransitionEnd,msTransitionEnd,KhtmlTransitionEnd".split(","), i = 0; i < h.length; i++) if (h[i] in e.style) {
    ...
    F = function(j, c) {
        ...
        function i(d, c) {
            ...
            f && (b.scrollmom && b.scrollmom.stop(), b.lastdeltax += f, b.synched("mousewheelx",
            function() {
                var d = b.lastdeltax;
                b.lastdeltax = 0;
                b.rail.drag || b.doScrollLeftBy(d)
            }));
            g && (b.scrollmom && b.scrollmom.stop(), b.lastdeltay += g, b.synched("mousewheely",
            function() {
                var d = b.lastdeltay;
                b.lastdeltay = 0;
        ...
        if (g.cantouch && g.ischrome && !g.isios && !g.isandroid) this.istouchcapable = true,
        g.cantouch = false;
        if (g.cantouch && g.ismozilla && !g.isios) this.istouchcapable = true,
        g.cantouch = false;
        ...
        this.css = function(d, c) {
            for (var f in c) b.saved.css.push([d, f, d.css(f)]),
            d.css(f, c[f])
        };
        ...
        this.updateScrollBar = function(d) {
            ...
            b.railh && b.railh.css({
                ...
                b.win.outerWidth();
                b.win.innerWidth();
                g += b.rail.align ? b.win.outerWidth() - h(b.win, "border-right-width") - b.rail.width: h(b.win, "border-left-width");
                ...
                b.zoom && b.zoom.css({
                    top: f + 1,
                    left: b.rail.align == 1 ? g - 20 : g + b.rail.width + 4
                });
                if (b.railh && !b.locked) f = c.top,
                g = c.left,
                d = b.railh.align ? f + h(b.win, "border-top-width", true) + b.win.innerHeight() - b.railh.height: f + h(b.win, "border-top-width", true),
                g += h(b.win, "border-left-width"),
                b.railh.css({
                    top: d,
                    left: g,
                    width: b.railh.width
        ...
        this.doRailClick = function(d, c, f) {
            var g; ! (b.rail.drag && b.rail.drag.pt != 1) && !b.locked && !b.rail.drag && (b.cancelScroll(), b.cancelEvent(d), c ? (c = f ? b.doScrollLeft: b.doScrollTop, g = f ? (d.pageX - b.railh.offset().left - b.cursorwidth / 2) * b.scrollratio.x: (d.pageY - b.rail.offset().top - b.cursorheight / 2) * b.scrollratio.y, c(g)) : (c = f ? b.doScrollLeftBy: b.doScrollBy, g = f ? b.scroll.x: b.scroll.y, d = f ? d.pageX - b.railh.offset().left: d.pageY - b.rail.offset().top, f = f ? b.view.w: b.view.h, g >= d ? c(f) : c( - f)))
        };
        ...
        this.init = function() {
            ...
            if (!b.ispage || !g.cantouch && !g.isieold && !g.isie9mobile) {
                ...
                b.ispage && g.isie7 && (b.doc[0].nodeName == "BODY" ? b.css(e("html"), {
                    "overflow-y": "hidden"
                ...
                y;
                for (y in j) i = j[y],
                (h = b.opt.railpadding[i]) ? f.css("padding-" + i, h + "px") : b.opt.railpadding[i] = 0;
                f.append(c);
                ...
                b.rail = f;
                c = b.rail.drag = false;
                if (b.opt.boxzoom && !b.ispage && !g.isieold && (c = document.createElement("div"), b.bind(c, "click", b.doZoom), b.zoom = e(c), b.zoom.css({
                    cursor: "pointer",
                ...
                b.railh && (k.css({
                    ...
                    if (b.ishwscroll) b.win.css("position") == "static" && b.css(b.win, {
                        position: "relative"
                    }),
                ...
                b.hide(),
                b.locked = false;
                if (g.isie9mobile) b.scrollmom = new z(b),
                ...
                b.bind(b.docscroll, "scroll", b.onmangotouch);
                    ...
                    if (g.cantouch || b.istouchcapable || b.opt.touchbehavior || g.hasmstouch) {
                        ...
                        b.ontouchstart = function(d) {
                            ...
                            if (!b.locked) {
                                ...
                                if (! ("clientX" in d) && "changedTouches" in d) d.clientX = d.changedTouches[0].clientX,
                                d.clientY = d.changedTouches[0].clientY;
                                if (b.forcescreen) f = d,
                                d = {
                                ...
                                if (!g.cantouch && !this.istouchcapable && !g.hasmstouch) {
                                    ...
                                    b.cancelEvent(d);
                                    if (/SUBMIT|CANCEL|BUTTON/i.test(e(c).attr("type"))) pc = {
                                        tg: c,
                                        click: false
                                    },
                                    b.preventclick = pc
                        ...
                        b.ontouchend = function(d) {
                            if (d.pointerType && d.pointerType != 2) return false;
                            if (b.rail.drag && b.rail.drag.pt == 2 && (b.scrollmom.doMomentum(), b.rail.drag = false, b.hasmoving && (b.hasmoving = false, b.lastmouseup = true, b.hideCursor(), g.hasmousecapture && document.releaseCapture(), !g.cantouch))) return b.cancelEvent(d)
                        };
                        ...
                        b.ontouchmove = function(d, c) {
                            ...
                            if (b.rail.drag && b.rail.drag.pt == 2) {
                                ...
                                d);
                                if ("changedTouches" in d) d.clientX = d.changedTouches[0].clientX,
                                d.clientY = d.changedTouches[0].clientY;
                                if (b.forcescreen) {
                                    var f = d,
                                    d = {
                                ...
                                if (b.ishwscroll && b.opt.bouncescroll) i < 0 ? i = Math.round(i / 2) : i > b.page.maxh && (i = b.page.maxh + Math.round((i - b.page.maxh) / 2));
                                else if (i < 0 && (h = i = 0), i > b.page.maxh) i = b.page.maxh,
                                h = 0;
                                var s = d.clientX + f;
                                if (b.railh && b.railh.scrollable) {
                                    ...
                                    else if (j < 0 && (s = j = 0), j > b.page.maxw) j = b.page.maxw,
                                    s = 0
                                }
                                b.synched("touchmove",
                                function() {
                                    b.rail.drag && b.rail.drag.pt == 2 && (b.prepareTransition && b.prepareTransition(0), b.rail.scrollable && b.setScrollTop(i), b.scrollmom.update(s, h), b.railh && b.railh.scrollable ? (b.setScrollLeft(j), b.showCursor(i, j)) : b.showCursor(i), g.isie10 && document.selection.clear())
                                });
                    ...
                    b.onmousemove = b.ontouchmove, g.cursorgrabvalue && (b.css(b.ispage ? b.doc: b.win, {
                        ...
                        if (! (b.rail.drag && b.rail.drag.pt != 1)) {
                            ...
                            var f = b.getTarget(d); ! b.ispage && g.hasmousecapture && f.setCapture();
                    ...
                    b.onmouseup = function(d) {
                        if (b.rail.drag && (g.hasmousecapture && document.releaseCapture(), b.isiframe && !g.hasmousecapture && b.doc.css("pointer-events", b.saved.csspointerevents), b.rail.drag.pt == 1)) return b.rail.drag = false,
                        b.cancelEvent(d)
                    },
                    ...
                    }); (g.cantouch || b.opt.touchbehavior) && b.bind(b.win, "mousedown", b.onmousedown);
                    ...
                    g.hasmousecapture && b.bind(b.win, "mouseup", b.onmouseup);
                    b.bind(document, "mousemove", b.onmousemove);
                    b.onclick && b.bind(document, "click", b.onclick); ! g.cantouch && !b.opt.touchbehavior && (b.rail.mouseenter(function() {
                    ...
                    b.opt.enablemousewheel && (b.isiframe || b.bind(g.isie && b.ispage ? document: b.docscroll, "mousewheel", b.onmousewheel), b.bind(b.rail, "mousewheel", b.onmousewheel), b.railh && b.bind(b.railh, "mousewheel", b.onmousewheelhr)); ! b.ispage && !g.cantouch && !/HTML|BODY/.test(b.win[0].nodeName) && (b.win.attr("tabindex") || b.win.attr({
                        tabindex: B++
                    }), b.win.focus(function(d) {
                ...
                b.onkeypress = function(d) {
                    ...
                    if (b.hasfocus || b.hasmousefocus && !r || b.ispage && !r && !w) {
                        ...
                        case 63275:
                            ...
                            break;
                        case 32:
                            b.opt.spacebarenabled && (b.doScrollBy( - b.view.h), l = true);
                            break;
                        case 27:
                ...
                if (!b.ispage && !b.haswrapper)"WebKitMutationObserver" in window ? (b.observer = new WebKitMutationObserver(function(d) {
                    ...
                    attributes: true,
                    subtree: false
                })) : (b.bind(b.win, g.isie && !g.isie9 ? "propertychange": "DOMAttrModified", b.onAttributeChange), g.isie9 && b.win[0].attachEvent("onpropertychange", b.onAttributeChange)); ! b.ispage && b.opt.boxzoom && b.bind(window, "resize", b.resizeZoom);
            ...
            if (this.doc[0].nodeName == "IFRAME") {
                var A = function() {
                    ...
                    if (g.cantouch || b.opt.touchbehavior) b.bind(d, "mousedown", b.onmousedown),
                    b.bind(d, "mousemove",
                    function(d) {
                        b.onmousemove(d, true)
                    }),
                    g.cursorgrabvalue && b.css(e(d.body), {
                        cursor: g.cursorgrabvalue
                    });
        ...
        this.onResize = function(d, c) {
            ...
            if (b.page.maxh == f && b.page.maxw == g && b.view.w == e) if (b.ispage) return b;
            else {
                f = b.win.offset();
        ...
        this._bind = function(d, c, f, g) {
            ...
            d.addEventListener ? d.addEventListener(c, f, g || false) : d.attachEvent ? d.attachEvent("on" + c, f) : d["on" + c] = f
        };
        this.bind = function(d, c, f, e) {
            var h = "jquery" in d ? d[0] : d;
            h.addEventListener ? (g.cantouch && /mouseup|mousedown|mousemove/.test(c) && b._bind(h, c == "mousedown" ? "touchstart": c == "mouseup" ? "touchend": "touchmove",
            function(b) {
                if (b.touches) {
                ...
                } else if (b.changedTouches) d = b.changedTouches[0],
                d.original = b,
                f.call(this, d)
            },
            e || false), b._bind(h, c, f, e || false), c == "mousewheel" && b._bind(h, "DOMMouseScroll", f, e || false), g.cantouch && c == "mouseup" && b._bind(h, "touchcancel", f, e || false)) : b._bind(h, c,
            function(d) {
        ...
        this.onmousewheel = function(d) {
            ...
            b.nativescrollingarea = b.isScrollable(d);
        ...
        this.doScrollPos = function(c, e, f) {
            ...
            i = b.getScrollLeft(); ((b.newscrolly - h) * (e - h) < 0 || (b.newscrollx - i) * (c - i) < 0) && b.cancelScroll();
            ...
            b.timer = setTimeout(function() {
                ...
                if (i > 0) { ! b.scrollrunning && b.onscrollstart && b.onscrollstart.call(b, {
                    ...
                    b.timerscroll = {
                        bz: new BezierClass(f, b.newscrolly, i, 0, 0, 0.58, 1),
        ...
        this.doScrollPos = function(c, e) {
            ...
            h = b.getScrollLeft(); ((b.newscrolly - g) * (e - g) < 0 || (b.newscrollx - h) * (c - h) < 0) && b.cancelScroll();
            b.newscrolly = e;
            b.newscrollx = c;
            ...
            if (!b.timer) { (g == b.page.maxh && e >= b.page.maxh || h == b.page.maxw && c >= b.page.maxw) && b.checkContentSize();
                var n = 1;
                ...
                f(); (g == b.page.maxh && e >= g || h == b.page.maxw && c >= h) && b.checkContentSize();
                b.noticeCursor()
            }
        },
        this.cancelScroll = function() {
        ...
        this.doScrollBy = function(c, e) {
            ...
            else if (f > b.page.maxh && py >= b.page.maxh) return b.checkContentSize(),
            b.noticeCursor();
            b.doScrollTop(f)
        };
        ...
        this.doZoomIn = function(c) {
            if (!b.zoomactive) {
                ...
                if (g.isios4) b.zoomrestore.scrollTop = e(window).scrollTop(),
    ...
    z = function(e) {
        ...
        this.doSnapy = function(e, i) {
            ...
            if (e < 0) e = 0,
            b = true;
            else if (e > c.nc.page.maxw) e = c.nc.page.maxw,
            b = true;
    ...
    })(v.prototype, "show,hide,toggle,onResize,resize,remove,stop,doScrollPos".split(","),
    function(e, c) {
        e[c] = function() {
            var e = arguments;
